...
class Sellkit_Fyfx {
	 ...
	 * @since    1.0.0
	 * @access   protected
	 * @var      Sellkit_Fyfx_Loader    $loader    Maintains and registers all hooks for the plugin.
	 */
	protected $loader;
	...
	public function __construct() {
		if ( defined( 'SELLKIT_FYFX_VERSION' ) ) {
			$this->version = SELLKIT_FYFX_VERSION;
		} else {
			$this->version = '1.0.0';
		}
	 ...
	 *
	 * - Sellkit_Fyfx_Loader. Orchestrates the hooks of the plugin.
	 * - Sellkit_Fyfx_i18n. Defines internationalization functionality.
	 * - Sellkit_Fyfx_Admin. Defines all hooks for the admin area.
	 * - Sellkit_Fyfx_Public. Defines all hooks for the public side of the site.
	 *
	 ...
	 *
	 * Uses the Sellkit_Fyfx_i18n class in order to set the domain and to register the hook
	 * with WordPress.
	 *
	 * @since    1.0.0
	 * @access   private
	...
	private function set_locale() {
		...
		$plugin_i18n = new Sellkit_Fyfx_i18n();
	 ...
	 *
	 * @since     1.0.0
	 * @return    Sellkit_Fyfx_Loader    Orchestrates the hooks of the plugin.
	 */
